...
void RadiationSimulation::RadiationSimulator::set_radiation_field_resolution(const glm::vec3& radiation_field_dimensions, const glm::vec3& radiation_field_voxel_dimensions, float radiation_field_max_energy, float energy_resolution, float statistical_error_threshold, float statistical_error_enforcement_ratio, const glm::uvec2& angular_resolution)
{
	RadiationSimulator::handler->set_radiation_field_resolution(radiation_field_dimensions, radiation_field_voxel_dimensions, radiation_field_max_energy, energy_resolution, statistical_error_threshold, statistical_error_enforcement_ratio, angular_resolution);
}
